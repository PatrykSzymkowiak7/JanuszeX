            ...
            <div class="container">
                ...
                @auth
                    ...
                    @if(Auth::user()->privilege_level == 1)
                        <a class="navbar-brand" href="{{ url('/MyWorkHours') }}">
                            Moje godziny pracy
                        </a>
                    @endif
                    @if(Auth::user()->privilege_level == 2 || Auth::user()->privilege_level == 3)
                        <a class="navbar-brand" href="{{ url('/EmployeeList') }}">
                            Zarządzaj godzinami pracy
                        </a>
                    @endif
                    @if(Auth::user()->privilege_level == 3)
                        <a class="navbar-brand" href="{{ url('/EmployeeListUser') }}">
